...
python3 kitti/prepare_data.py --car_only --gen_train --gen_val --gen_val_rgb_detection 
...
python3 kitti/prepare_data_refine.py --car_only --gen_train --gen_val_det --gen_val_rgb_detection
