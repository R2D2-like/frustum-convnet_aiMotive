...
python3 kitti/prepare_data.py --car_only --gen_val_rgb_detection 
python3 train/test_net_det.py --cfg cfgs/det_sample.yaml OUTPUT_DIR $OUTDIR TEST.WEIGHTS $OUTDIR/model_0050.pth 
python3 kitti/prepare_data_refine.py --car_only --gen_from_folder pretrained_models/car/val_nms/result/data
